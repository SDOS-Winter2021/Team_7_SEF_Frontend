...
function DonorVisualisation(props) {

  const data = [
    {x: 'Q1', y: props.donorsQ1},
    {x: 'Q2', y: 0},
    {x: 'Q3', y: 0},
    {x: 'Q4', y: 0},
  ];
  ...
  return (
    <DonorVisualisationClass labeldata={labelData} data={data}/>
  )
}

export default DonorVisualisation

class DonorVisualisationClass extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <XYPlot xType="ordinal" width={750} height={400} color="#5bc0de">
          <VerticalGridLines />
          <HorizontalGridLines />
          <XAxis />
          <YAxis />
